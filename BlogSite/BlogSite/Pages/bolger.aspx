        ...
        <div id="tooplate_content">
            ...
            <div>
                <div id="Blogging Page">
                    ...
                    <input type="text" class="input" name="PostTitle" id="postTitle" placeholder="Write your title here...."/>
                    <div class="cleaner h10">
                        ...
                        <label for="edit">
                            ...
                            <asp:Button CssClass="button" ID="publishButton" runat="server" Text="Publish" OnClick="publishButton_Click" />
                        </label>
                    </div>
